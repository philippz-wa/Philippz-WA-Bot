...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'ttp ?(.*)', fromMe: true, desc: Lang.TTP_DESC }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'DA KOCH MYREA !! 😁 *INNADA MYREA NINTA TTP 😌*  *_THANKS TO :_* _R45H4N 9H1L199,4N7RU_CYB3R_50UL_' })
