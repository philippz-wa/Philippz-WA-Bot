...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'animesay ?(.*)', fromMe: true, desc: Lang.ANIME_DESC }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.png, caption: 'DA KOCH MYREA!! 😁 *INNADA MYREA NINTA ANIME SAY 😌*  *_THANKS TO :_* _R45H4N 9H1L199,4N7RU_CYB3R_50UL_' })
    ...
    Asena.addCommand({ pattern: 'changesay ?(.*)', fromMe: true, desc: Lang.CHANGE_DESC }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.png, caption: 'DA KOCH MYREA !! 😁 *INNADA MYREA NINTA CHANGE SAY 😌*  *_THANKS TO :_* _R45H4N 9H1L199,4N7RU_CYB3R_50UL_' })
    ...
    Asena.addCommand({ pattern: 'trumpsay ?(.*)', fromMe: true, desc: Lang.TRUMP_DESC }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.png, caption: 'DA KOCH MYREA!! 😁 *INNADA MYREA NINTA TRUMP SAY 😌*  *_THANKS TO :_* _R45H4N 9H1L199,4N7RU_CYB3R_50UL_' })
