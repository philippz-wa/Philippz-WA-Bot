...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'carbon ?(.*)', fromMe: true, desc: Lang.CARBON_DESC, warn: Lang.CARBON_WARN}, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,Buffer.from(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'DA KOCH MYREA!! 😁 *INNADA MYREA NINTA CARBON 😌*  *_THANKS TO :_* _R45H4N 9H1L199,4N7RU_CYB3R_50UL_'})
